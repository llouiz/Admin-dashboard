...
<body>
 ...
 %></span></a>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-th-list"></i>Weapon Table</li>
						</ol>
					</div>
				</div>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<div class="table-title">
									<div class="row">
										<div class="col-sm-6">
											<a href="#addWeaponModal" class="btn btn-success"
							...
							<table id="data-table-basic"
								...
								<thead>
									<tr>
										...
										<th><i class="fa fa-fighter-jet" aria-hidden="true"></i> Attack Speed</th>
										<th><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> Droppable</th>
										<th><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> Level</th>
										<th><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> Critical Damage</th>
										<th><i class="icon_cogs"></i> Action</th>
									</tr>
								</thead>
								<%
									ArrayList<Weapon> list = WeaponDAO.getAllWeapon();
								...
								<tr>
									...
									<td>
										<div class="btn-group">
											...
											<a href="edit_weapon.jsp?u=<%= w.getId()%>" class="btn btn-primary" data-toggle="modal" 
											><i
												class="fa fa-pencil" aria-hidden="true"></i></a> <a
												class="btn btn-danger" href="WeaponController?d=<%= w.getId() %>"><i
				...
				<div class="modal-content">
					<form action="WeaponController" method="post">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label>Attack speed</label> <input name="atk_speed" type="number" step="0.01" class="form-control"
									required>
							</div>
							<div class="form-group">
								<label>Droppable</label> <input name="droppable" type="text"
									class="form-control" required>
							</div>
							<div class="form-group">
								<label>Level</label> <input name="level" type="number"
									class="form-control" required>
							</div>
							<div class="form-group">
								<label>Critical damage</label> <input name="c_damage" type="number"
									class="form-control" required>
							</div>
						</div>
		...
		<div id="updateWeaponModal" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					<form action="WeaponController" method="post">
						<div class="modal-header">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label>Droppable</label> <input name="droppable" type="number"
									class="form-control" required>
							</div>
						</div>
